...
class OCRTOC_task_5_1_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_5_1_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_2_1_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_2_1_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_0_0debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_0_0_debug,
            **kwargs,
        )     
...
class OCRTOC_task_1_4_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_1_4_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_4_2_3debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_4_2_3_debug,
            **kwargs,
        )     
...
class OCRTOC_task_0_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_0_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_0_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_0_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_5_3_3debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_5_3_3_debug,
            **kwargs,
        )     
...
class OCRTOC_task_6_2_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_6_2_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_0_4debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_0_4_debug,
            **kwargs,
        )     
...
class OCRTOC_task_4_3_4debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_4_3_4_debug,
            **kwargs,
        )     
...
class OCRTOC_task_4_3_3debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_4_3_3_debug,
            **kwargs,
        )     
...
class OCRTOC_task_3_1_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_3_1_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_4_2_4debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_4_2_4_debug,
            **kwargs,
        )     
...
class OCRTOC_task_2_2_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_2_2_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_1_5_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_1_5_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_6_1_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_6_1_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_5_3_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_5_3_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_3_2_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_3_2_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_5_1_3debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_5_1_3_debug,
            **kwargs,
        )     
...
class OCRTOC_task_1_5_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_1_5_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_6_3_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_6_3_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_2_2_3debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_2_2_3_debug,
            **kwargs,
        )     
...
class OCRTOC_task_6_1_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_6_1_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_4_3_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_4_3_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_1_2_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_1_2_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_2_2_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_2_2_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_1_3_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_1_3_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_6_3_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_6_3_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_1_1_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_1_1_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_0_3debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_0_3_debug,
            **kwargs,
        )     
...
class OCRTOC_task_4_1_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_4_1_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_4_3_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_4_3_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_4_2_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_4_2_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_6_3_3debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_6_3_3_debug,
            **kwargs,
        )     
...
class OCRTOC_task_3_2_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_3_2_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_4_2_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_4_2_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_5_2_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_5_2_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_6_2_3debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_6_2_3_debug,
            **kwargs,
        )     
...
class OCRTOC_task_5_2_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_5_2_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_3_3_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_3_3_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_4_1_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_4_1_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_3_3_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_3_3_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_2_2_4debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_2_2_4_debug,
            **kwargs,
        )     
...
class OCRTOC_task_6_2_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_6_2_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_1_1_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_1_1_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_0_5debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_0_5_debug,
            **kwargs,
        )     
...
class OCRTOC_task_1_5_3debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_1_5_3_debug,
            **kwargs,
        )     
...
class OCRTOC_task_2_1_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_2_1_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_1_2_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_1_2_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_5_1_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_5_1_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_1_4_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_1_4_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_3_1_1debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_3_1_1_debug,
            **kwargs,
        )     
...
class OCRTOC_task_5_3_2debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_5_3_2_debug,
            **kwargs,
        )     
...
class OCRTOC_task_1_1_3debug(FrankaEnv):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model_path=model_path_1_1_3_debug,
            **kwargs,
        )     
